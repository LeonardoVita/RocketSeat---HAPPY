...
export default function OrphanageDetails() {
  ...
  useEffect(()=>{
    ...
    async function getData() {
      const res = await backend.get(`/orphanages/${params.id}`);
  ...
  function handleGoogleMapButtom(){
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity style={styles.routesContainer} onPress={()=> handleGoogleMapButtom()}>
